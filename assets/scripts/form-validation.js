var FormValidation = function () {
    ...
    var handleValidationExcel = function() {
        // for more info visit the official plugin documentation: 
            // http://docs.jquery.com/Plugins/Validation

            var formExcel = $('#form_sample_excel');
            var errorExcel = $('.alert-error', formExcel);
            var successExcel = $('.alert-success', formExcel);
