            ...
            <div class="span12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-tasks"></i> Station A - Panel Counting</div>
                        <div class="actions">
                    ...
                    <div id="div_search" class="portlet-body table-bottom" style="display: block;">
                        <form action="<?php echo site_url('transaction/station_a'); ?>" id="form_sample_1" class="form-horizontal" method="get" enctype="multipart/form-data">
            ...
            if($production_order <> ""){ ?>
                    ...
                    <form id="form-scan" action="<?php echo site_url('transaction/scan_panel'); ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-actions">
                            <span class="pull-right">
                                ...
                                <input type="hidden" name="position" value="23">
                                <input type="hidden" name="position_new" value="24">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe style="height: 500px;" src="<?=base_url()?>transaction/station_a_panel/<?php echo $production_order ?>/<?php echo $row['module'] ?>" class="span12">
                ...
                <div class="row-fluid">
                    <form name="aaaa" method="post" action="<?php echo site_url('transaction/export_station'); ?>">
                        ...
                        <input type="hidden" id="position" name="position" value="23" >
