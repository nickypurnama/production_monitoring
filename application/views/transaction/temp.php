            ...
            <div class="span12">
                ...
                <div class="portlet">
                                        ...
                                        foreach($production_order as $row){ 
                                            ...
                                            if($row['message'] <> "OK"){ 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 60px; color: red;"><?php echo $row['so_vmk'] ?></td>
                                                    <td style="width: 60px; color: red;"><?php echo $row['po_vmk'] ?></td>
                                                    <td style="width: 60px; color: red;"><?php echo $row['order_description'] ?></td>
                                                    <td style="width: 60px; color: red;"><?php echo $row['line_description'] ?></td>
                                                    ...
                                                    <div class="modal fade" id="deleteModal-<?php echo $id ?>" role="dialog">
                                                        <div class="modal-dialog">
                                                            <form action="<?php echo site_url('transaction/delete_temp'); ?>" method="post" style="margin-bottom: 0px;">
                    ...
                    <div class="pull-right">
                        ...
                        <?php
                            if($error == 0){ ?>
                                <a href="<?php echo site_url('transaction/input_temp'); ?>"><button class="btn brown"> Continue</button></a>
                            <?php }
                        ?>
                    </div>
                    <br><br>
