...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#qrcode-text').keyup(function(){
            if((this.value.includes('xxl') || this.value.includes('xml'))){
                $('#qrcode-submit').click();
            }
        });
            ...
            <div class="span12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-tasks"></i> Station B - QC</div>
                        <div class="actions">
                    ...
                    <div id="div_search" class="portlet-body table-bottom" style="display: block;">
                        <form action="<?php echo site_url('transaction/station_b'); ?>" id="form_sample_1" class="form-horizontal" method="get" enctype="multipart/form-data">
            ...
            if($production_order <> ""){ ?>
                    ...
                    <form id="form-scan" action="<?php echo site_url('transaction/scan_panel'); ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-actions">
                            <span class="pull-right">
                                ...
                                <input type="hidden" name="position_new" value="25">
                        ...
                        foreach($module as $row){ 
                            ...
                            <a data-toggle="modal" data-target="#modal-<?php echo $no ?>">
                                <div class="span2 item-block <?php echo $class ?>">
                                    <p>MODUL: <?php echo $row['module'] ?><br>PART QTY: <?php echo $row['total_scan'] ?>/<?php echo $row['total_panel'] ?></p>
                                </div>
                            </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="height: 500px;">
                                            <iframe style="height: 500px;" src="<?=base_url()?>transaction/station_b_panel/<?php echo $production_order ?>/<?php echo $batch ?>/<?php echo $type ?>/<?php echo $row['production_order_item_id'] ?>/<?php echo $row['module'] ?>" class="span12">
                ...
                <div class="row-fluid">
                    <form name="aaaa" method="post" action="<?php echo site_url('transaction/export_station'); ?>">
                        ...
                        <input type="hidden" id="position" name="position" value="24" >
