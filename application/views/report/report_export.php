            ...
            <div class="span12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-tasks"></i> Report Excels</div>
                    </div>
                    <div class="portlet-body table-bottom" style="display: block;">
                        <form action="<?php echo site_url('report/report_export_data'); ?>" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-actions">
                                <span class="pull-right">
                                    ...
                                    <button type="submit" class="btn brown"><i class="icon-ok"></i> Export</button>
                                </span>
                            </div>
                        </form> 
                    </div>
