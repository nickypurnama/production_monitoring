...
class CI_DB_oci8_driver extends CI_DB {
	 ...
	 * @return  resource
	 */
	var $binds = FALSE;    // Modifikasi Tambahan
...
//		}
	...
	{
		$limit = $offset + $limit;
		$cols=substr($sql,6,strpos($sql,'FROM')-6);
		$newsql = "SELECT ".$cols." FROM (select rownum rnum, inner_query.*  FROM ($sql) inner_query WHERE rownum < $limit)";
